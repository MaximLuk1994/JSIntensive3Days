...
window.addEventListener('DOMContentLoaded', () => { //Когда загрузилась именно вёрстка
    ...
    const loadContent = async (url, callback) => {
        await fetch(url)
            ...
            .then(json => createElement(json)) //Чтобы обратиться именно к goods в json-е. Чтобы функция была универсальной, надо бы по-другому
...
//Глянуть про JSON сервер https://github.com/typicode/json-server
//Его плюс - когда запускаем, можем не только получать, но и пушить данные